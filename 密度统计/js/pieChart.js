...
function pieChart() {
  ...
  var pullOutShadowOffsetX = 2;                     // X-offset (in pixels) of the pull-out slice shadow
  var pullOutShadowOffsetY = 2;                     // Y-offset (in pixels) of the pull-out slice shadow
  ...
  var pullOutBorderStyle = "none";                  // Colour of the pull-out slice border
  ...
  function init() {
    ...
    $('#chartData td').each( function() {
      ...
      $(this).mouseover( handleTableClick );
